...
On completion, TeachOSM for High School will equip high school educators with a module-arranged, scalable content, providing seamless incorporation into their existing geography curriculum, sensitive of the AP Human Geography schedule. This will not negatively impact instructor workload and student education.
...
* _Consolidate_ all materials on the **[TeachOSM website](http://teachosm.org)**
...
#### 2. **Develop "Module 2 | Introduction to OpenStreetMap"**
  * **Summary:** This module will organize introductory level resources with that provide the teacher with a _simple_ but comprehensive overview of the OSM project with content that covers:
    ...
    4. a visualization of live edits using
      * **[OSM Show Me the Way](https://osmlab.github.io/show-me-the-way/)**
      * **[OSM Live Edits](http://live.openstreetmap.fr/)**
...
#### 4. **Develop "Module 4 | OSM Mapping Practice - Editing"**
  ...
  * **Obvious AP Human Geography Link(s):**
    1. Interpret maps and analyze geospatial data
  * **Student Assignment:**
    1. Complete the **[HOTOSM Introduction to iD Editor](http://courses.hotosm.org/course/index.php?categoryid=1)** and capture screen shots indicating completion to enter into the student journal
...
#### 8. **Develop "Module 8 | Mapping Agricultural and Rural Land Use OSM Map Features"**
  ...
  * **[MOZILLA GLOBAL SPRINT DAY 2017 (June 1 - 2, 2017)](https://science.mozilla.org/programs/events/global-sprint-2017)**
