...
**Activity Title:**** ** This module provides an overview and explanation of the TeachOSM for High School modules and how to use them.  This module is an introduction to the TeachOSM for High School project for educators prior to introducing students to Modules 1-12.
...
**Made by:** TeachOSM and OSM contributors

**Time: **less than 1 hour

**Activity X of Y** 0 of 12

**Read | Write | Participate on the Web **Read
...
Teachers should acquaint themselves with OSM[OpenStreetMap](https://openstreetmap.org) and have a basic understanding of open mapping.  Visit the OpenStreetMap [website](https://openstreetmap.org) and skim the pages of the OpenStreetMap OSM wiki[wiki](https://wiki.openstreetmap.org). 

**Important:**

* **OSM**OpenStreetMap does not work with the MS Internet Explorer web browser.  Use Mozilla Firefox, Chrome, Safari, or Opera.

* Tablets are NOT recommended for open mapping.  Either useUse a mouse with either a desktop or laptop computer with a tracking pad.
...
This is the Overview Module intended to give teachers a summary overview of the individual modules included in the TeachOSM for High School project.  The modules are primarily intended to help AP Human Geography teachers to connect open mapping to the AP Human Geography curriculum.  TBut the modules are freely adaptable by teachers in other subject matter domains as well (e.g. U.S. History, Environmental Science, etc.).

This TeachOSM for High School project provides educators with scale-able OSM[OpenStreetMap](https://www.openstreetmap.org/) (OSM) geography-based educational modules developed to integrate with the [United States AP Human Geography curriculum](https://apstudent.collegeboard.org/apcourse/ap-human-geography), exposing students to 21st century mapping technology. The modules have been developed under the [TeachOSM](http://teachosm.org/) project umbrella.

* *Everyone* is invited to collaborate to contribute to the continued development ofproduce this meaningful organization of secondary education-level materials.
...
This project was also part These modules were also developed as one of [Mozilla's Open Leadership Training](https://mozilla.github.io/leadership-training/projects/#teachosm-for-high-school) Round 3 cohort projects. The Open Leadership Training is a 14 week online mentorship program on working open in the Mozilla Network. The project wasis one of 39 selected from a pool of over 100 applications for this cohort.

To date, open mapping materials suitable for the AP Human Geography curriculum have not been organized and provided in a centralized, readily available, on-demand implementable state to educators.  Additionally, training for teachers integrating this type of work has not been available to educators.  This project aims to remedy thesedy that.
...
Modules 1 through 4 feature an introduction to the OSMOpenStreetMap toolkit: FieldPapers for field data collection, a brief history on the rise of OSMOpenStreetMap, managing OSMOpenStreetMap accounts and the OSMOpenStreetMap interface, and basic editing techniques in OSMOpenStreetMap.
